<?php
/**
 * Plugin Name:       Logsalot
 * Description:       A plugin that replaces the WordPress login flow with a custom page.
 * Version:           1.0.0
 * Author:            Neil Gowran
 * @link https://code.tutsplus.com/tutorials/build-a-custom-wordpress-user-flow-part-1-replace-the-login-page--cms-23627
 * License:           GPL-2.0+
...
class Personalize_Login_Plugin {
	...
	private function verify_recaptcha() {
        ...
        private function get_error_message( $error_code ) {
            switch ( $error_code ) {
                case 'empty_username':
                    return __( 'You need to enter a username', 'personalize-login' );
